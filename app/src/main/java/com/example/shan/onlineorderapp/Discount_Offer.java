...
public class Discount_Offer extends Fragment {
    private ProgressDialog progressDialog;
    String path;
    private static final String LOG_TAG = Discount_Offer.class.getSimpleName();
    private int  mOkay;
    SQLiteDatabase db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.discount__offer,container,false);


        LinearLayoutManager llm = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        RecyclerView rv = (RecyclerView) v.findViewById(R.id.my_recycler_view_discount);

        rv.setLayoutManager(llm);
        rv.setHasFixedSize(true); // to improve performance
        DiscountAdapter adapter = new DiscountAdapter(new String[8]);
