...
public class Product_Main extends Fragment {
    ...
    String path;
    private static final String LOG_TAG = Product_Main.class.getSimpleName();
    private int  mOkay;
    SQLiteDatabase db;
    ...
    public void getDataFromSQliteDb(){

        String selectQuery = "SELECT  * FROM " + RequestDBHelper.PRODUCT_TABLE_NAME ;
        mDbHelper = new RequestDBHelper(getActivity());
